...
{
    public IMultiplayService multiplayService;
    ...
    public async Task BeginServerCheck()
    {
        ...
        // setup server : amount player, server name, gametype, build
        serverCheckManager = await multiplayService.StartServerQueryHandlerAsync((ushort)6, "ServerName", "", "0", "");
